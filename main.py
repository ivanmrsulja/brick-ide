...
from CompilationDialog import CompilatonDialog
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowIcon(QIcon(QtGui.QPixmap("../Editor/images/window_icon.png")))
        ...
        debug_btn.setIcon(QtGui.QIcon(QtGui.QPixmap("../Editor/images/debug.png")))
    ...
    def build_c(self):
        ...
        os.system("gnome-terminal -e 'bash -c \"" + command + "; read -n1 -r -p " + phrase + " key; exec bash \"'")
